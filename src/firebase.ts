...
import { getFirestore, doc, setDoc, getDoc, collection, addDoc, onSnapshot, query, orderBy, limit, getDocFromServer } from 'firebase/firestore';
...
export { signInWithPopup, signInWithRedirect, signOut, onAuthStateChanged, type User };
